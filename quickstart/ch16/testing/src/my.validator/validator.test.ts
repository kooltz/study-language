...
describe('숫자 검증하기', () => {
    it('폰 번호 - 번호에 대한 true 테스트', () => {
        ...
        expect(Validator.isPhone("016-1111-1111")).to.be.true;
        expect(Validator.isPhone("019-1111-1111")).to.be.true;
    });
    ...
    it('폰 번호 - 앞자리에 대한 false 테스트', () => {
        ...
        expect(Validator.isPhone("014-1111-11111")).to.be.false;
        expect(Validator.isPhone("015-1111-11111")).to.be.false;
    });
});