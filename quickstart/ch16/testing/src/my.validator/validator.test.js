...
describe('문자열 검증하기', function () {
    it('URL - 주소에 대한 true 테스트', function () {
        expect(validator_1.Validator.isURL("http://books.google.com")).to.be["true"];
    });
    it('URL - 형식에 대한 false 테스트', function () {
        expect(validator_1.Validator.isURL('books.google.com')).to.be["false"];
        expect(validator_1.Validator.isURL('http:books.google.com')).to.be["false"];
        expect(validator_1.Validator.isURL('http:\\books.google.com')).to.be["false"];
    });
});
describe('숫자 검증하기', function () {
    it('폰 번호 - 번호에 대한 true 테스트', function () {
        ...
        expect(validator_1.Validator.isPhone("016-1111-1111")).to.be["true"];
        expect(validator_1.Validator.isPhone("019-1111-1111")).to.be["true"];
    });
    ...
    it('폰 번호 - 앞자리에 대한 false 테스트', function () {
        ...
        expect(validator_1.Validator.isPhone("014-1111-11111")).to.be["false"];
        expect(validator_1.Validator.isPhone("015-1111-11111")).to.be["false"];
    });
});
